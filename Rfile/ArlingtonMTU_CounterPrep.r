...
EFC10 <- read.csv("2010_WOD_EFC12.07_12.31_15mins.csv")
...
CCityCon11 <- read.csv("2011_CrystalCityCon09.02_12.31_15 mins.csv")
...
BonAir_Custis10 <- read.csv("2010_Custis_BA12.08_12.31_15mins.csv")
BonAir_Custis11 <- read.csv("2011_Custis_BA 01.01-12.31 15 mins.csv")
...
Rosslyn09 <- read.csv("2009_Custis_Rosslyn10.15_12.31_15mins.csv")
Rosslyn10 <- read.csv("2010_Custis_Rosslyn01.01_12.31_15mins.csv")
Rosslyn11 <- read.csv("2011_Custis_Rosslyn01.01_12.31_15mins.csv")
...
FourMile11 <- read.csv("2011_FMR_Pyro03.04_12.31_15mins.csv")
FourMile12 <- read.csv("2012 FMR Pyro 01.01-12.31 15 mins.csv")
FourMile13 <- read.csv("2013 FMR Pyro 01.01-12.31 15 mins.csv")

KeyBridgeEast11 <- read.csv("2011_Key_Bridge_E08.12_12.31_15mins.csv")
...
KeyBridgeWest11 <- read.csv("2011_Key_Bridge_W 08.11-12.31 15 mins.csv")
...
Airport11 <- read.csv("2011_MVT_Airport_S_09.01_12.31_15mins.csv")
...
# remove first day of each counter's data to remove unusual activity due to setup/calibration 
EFC10 <- subset(EFC10, Date != "07/12/2010")
TR_Island11 <- subset(TR_Island11, Date != "14/10/2011")
BonAir_WOD_East11 <- subset(BonAir_WOD_East11, Date != "21/01/2011")
ColPike11 <- subset(ColPike11, Date != "14/10/2011")
CCityCon11 <- subset(CCityCon11, Date != "02/09/2011")
BonAir_Custis10 <- subset(BonAir_Custis10, Date != "08/12/2010")
Rosslyn09 <- subset(Rosslyn09, Date != "15/10/2009")
FourMile11 <- subset(FourMile11, Date != "04/03/2011")
KeyBridgeEast11 <- subset(KeyBridgeEast11, Date != "12/08/2011")
KeyBridgeWest11 <- subset(KeyBridgeWest11, Date != "11/08/2011")
Airport11 <- subset(Airport11, Date != "01/09/2011")
Ballston12 <- subset(Ballston12, Date != "06/12/2012")
Bluemont13 <- subset(Bluemont13, Date != "22/11/2013")
JoyceNB13 <- subset(JoyceNB13, Date != "20/06/2013")
JoyceSB13 <- subset(JoyceSB13, Date != "20/06/2013")
...
#Adding Location Tag Columns to all, and normalizing other variables
...
BonAir_WOD11$Location<- "BonAir_East"
BonAir_WOD11$PedTOTAL <- BonAir_WOD11$PedIN + BonAir_WOD11$PedOUT
BonAir_WOD11$BikeTOTAL<-BonAir_WOD11$BikeIN + BonAir_WOD11$BikeOUT
BonAir_WOD11$TotalOUT<-BonAir_WOD11$PedOUT + BonAir_WOD11$BikeOUT
BonAir_WOD11$TotalIN<-BonAir_WOD11$PedIN + BonAir_WOD11$BikeIN
...
Arl_MTU_Combined <- rbind(Airport11,Airport12,Airport13,Ballston12,Ballston13,
                          Bluemont13,BonAir_Custis10,BonAir_Custis11,BonAir_Custis12,
                          BonAir_Custis13,BonAir_WOD_East11,BonAir_WOD_East12,
                          BonAir_WOD_West12,CCityCon11,CCityCon12,CCityCon13,ColPike11,
                          ColPike12, EFC10, EFC11, EFC12, FourMile11, FourMile12, FourMile13,
                          JoyceNB13, JoyceSB13,KeyBridgeEast11, KeyBridgeEast12, 
